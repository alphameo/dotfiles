...
map("n", "<leader>lp", ":LspTinymistExportPng<CR>", { buffer = true, silent = true, desc = "Typst Export PNG" })
map("n", "<leader>ls", ":LspTinymistExportSvg<CR>", { buffer = true, silent = true, desc = "Typst Export SVG" })
map("n", "<leader>lP", ":LspTinymistExportPdf<CR>", { buffer = true, silent = true, desc = "Typst Export PDF" })
map("n", "<leader>lm", ":LspTinymistExportPdf<CR>", { buffer = true, silent = true, desc = "Typst Export Markdown" })
