...
local setup_tabline = function()
  ...
  vim.keymap.set("n", "<A-]>", ":bnext<CR>", { silent = true, desc = "Next Tab (buffer)" })
  vim.keymap.set("n", "<C-Tab>", ":bnext<CR>", { silent = true, desc = "Next Tab (buffer)" })
  vim.keymap.set("n", "<A-[>", ":bprev<CR>", { silent = true, desc = "Previous Tab (buffer)" })
  vim.keymap.set("n", "<C-S-Tab>", ":bprev<CR>", { silent = true, desc = "Previous Tab (buffer)" })
  vim.keymap.set("n", "<A-g>", ":Telescope buffers<CR>", { silent = true, desc = "Pick Tab (buffer) Next" })
  vim.keymap.set("n", "<A-w>", ":Bdelete<CR>", { silent = true, desc = "Pick buffer to close" })
  vim.keymap.set("n", "<A-\\>", "<C-^>", { silent = true, desc = "Switch to last buffer" })
end
