...
-- Terminal
map("n", "<leader>tt", ":enew<CR>:terminal<CR>a", { silent = true, desc = "New Terminal" })
map("t", "<ESC>", "<C-\\><C-n>", { remap = true, desc = "Exit Terminal Mode" })
map("t", "<A-t>", "<C-\\><C-n><A-t>", { remap = true, desc = "Termi: Tab New" })
map("t", "<A-w>", "<C-\\><C-n><A-w>", { remap = true, desc = "Termi: Tab Quit" })
map("t", "<A-]>", "<C-\\><C-n><A-]>", { remap = true, desc = "Termi: Next Tab (buffer)" })
map("t", "<A-[>", "<C-\\><C-n><A-[>", { remap = true, desc = "Termi: Previous Tab (buffer)" })
map("t", "<A-s>", "<C-\\><C-n><A-s>", { remap = true, desc = "Termi: Window Horizontal Split" })
map("t", "<A-v>", "<C-\\><C-n><A-v>", { remap = true, desc = "Termi: Window Vertical Split" })
map("t", "<A-q>", "<C-\\><C-n><A-q>", { remap = true, desc = "Termi: Window Quit" })
map("t", "<A-k>", "<C-\\><C-n><C-k>", { remap = true, desc = "Termi: Go to Upper window" })
map("t", "<A-j>", "<C-\\><C-n><A-j>", { remap = true, desc = "Termi: Go to Lower window" })
map("t", "<A-h>", "<C-\\><C-n><A-h>", { remap = true, desc = "Termi: Go to Left window" })
map("t", "<A-l>", "<C-\\><C-n><A-l>", { remap = true, desc = "Termi: Go to Right window" })
map("t", "<A-=>", "<C-\\><C-n><A-=>", { remap = true, desc = "Termi: Window Taller" })
map("t", "<A-->", "<C-\\><C-n><A-->", { remap = true, desc = "Termi: Window Shorter" })
map("t", "<A-.>", "<C-\\><C-n><A-.>", { remap = true, desc = "Termi: Window Wider" })
map("t", "<A-,>", "<C-\\><C-n><A-,>", { remap = true, desc = "Termi: Window Narrower" })
